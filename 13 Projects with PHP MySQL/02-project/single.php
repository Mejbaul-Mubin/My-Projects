          ...
          >
            <div class="row align-items-center">
              <div class="col-md-12 mb-3 mb-sm-0">
                ...
                <p>
                  Appropriately cultivate principle-centered infrastructures via
                  world-class niches. Professionally morph cooperative methods
                  of empowerment for out-of-the-box resources. Monotonectally
                  create cross-unit web services via efficient vortals. Quickly
                  architect bleeding-edge niche markets rather than
                  goal-oriented vortals. Completely grow reliable customer
                  service rather than interdependent action items. Quickly
                  engineer installed base content via client-based action items.
                  Seamlessly transition backend models whereas business
                  imperatives. Collaboratively optimize resource-leveling
                  catalysts for change after cross-media paradigms. Assertively
                  network extensible e-commerce whereas timely intellectual
                  capital. Appropriately revolutionize premier infomediaries.
                </p>
                <p class="text-sm">
                ...
                <div class="text-sm op-5">
                  <a class="text-black mr-2" href="#">Programming</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row align-items-center">
              <div class="col-md-12 mb-3 mb-sm-0">
                ...
                <p class="text-sm">
                  ...
                  <a class="text-black" href="#">20 minutes</a> ago
                </p>
              </div>
            </div>
          </div>
